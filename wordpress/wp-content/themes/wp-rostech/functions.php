...
if (function_exists('register_sidebar')) {
  ...
  register_sidebar(array(
    ...
    'id' => 'widgetarea2',
    'before_widget' => '<div id="%1$s" class="col-md-6 col-sm-6 col-xs-12 footernav footernav-first %2$s">',
    'after_widget' => '</div>',
    'before_title' => '<h6>',
    'after_title' => '</h6>'
  ));
...
/* Source: http://stackoverflow.com/questions/10376891/make-get-adjacent-post-work-across-custom-post-types */
/* Copiar esto en functions.php */
/*
